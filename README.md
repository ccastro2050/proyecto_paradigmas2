...
> el puerto 8003 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                 STATUS                    PORTS
> proyecto_paradigmas2-api-facturas-1   Up 2 hours                0.0.0.0:8003->8003/tcp
> proyecto_paradigmas2-postgres-1       Up 2 hours (healthy)      0.0.0.0:15433->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_paradigmas2.git
cd proyecto_paradigmas2
...
| Qué | Dónde |
|---|---|
| **API Facturas — Swagger** (probar los endpoints) | http://localhost:8003/docs |
| Diagnóstico | http://localhost:8003/ |
| PostgreSQL (para DBeaver/pgAdmin, opcional) | `localhost:15433` · `paradigmas`/`paradigmas123` |
...
│
├── api_facturas/                # LA API DE LA v1 — FastAPI (puerto 8003)
